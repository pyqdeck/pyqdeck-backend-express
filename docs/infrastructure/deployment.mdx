...
2. **Coverage** is uploaded to Codecov — minimum thresholds: 80% lines/functions/statements, 65% branches
...
| Engineering Docs | Mintlify | GitHub integration | docs.pyqdeck.in |
