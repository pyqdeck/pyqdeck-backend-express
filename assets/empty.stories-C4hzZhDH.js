import{n as e,s as t}from"./chunk-CzyJ72yW.js";import{Br as n,o as r,s as i}from"./iframe-DzIwxAOs.js";import{n as a,t as o}from"./dist-DTXUM9xK.js";import{A as s,D as c,P as l,t as u,tt as d}from"./lucide-react-CJ-EXKIz.js";import{r as f,t as p}from"./button-BHlAz4HL.js";import{a as m,i as h,n as g,o as _,r as v,s as y,t as b}from"./empty-BBdJIdfR.js";var x,S,C,w,T,E,D,O,k;e((()=>{x=t(n(),1),a(),u(),y(),f(),i(),S={title:`UI/Empty`,component:b,tags:[`autodocs`],argTypes:{className:{control:`text`,description:`Additional CSS classes for the container`},children:{control:!1,description:`Content of the empty state`}},parameters:{docs:{description:{component:`Empty state component used when there is no content to display.
It provides a consistent layout for icons, titles, descriptions, and call-to-action buttons.`}}}},C=e=>(0,x.jsx)(b,{...e,className:r(`min-h-[400px]`,e.className)}),w={render:C,args:{children:(0,x.jsxs)(x.Fragment,{children:[(0,x.jsxs)(h,{children:[(0,x.jsx)(m,{variant:`icon`,children:(0,x.jsx)(l,{})}),(0,x.jsx)(_,{children:`No universities found`}),(0,x.jsx)(v,{children:`You haven't added any universities to the system yet.`})]}),(0,x.jsx)(g,{children:(0,x.jsxs)(p,{onClick:o(),children:[(0,x.jsx)(s,{className:`mr-2 size-4`}),`Add University`]})})]})}},T={render:C,args:{children:(0,x.jsxs)(x.Fragment,{children:[(0,x.jsxs)(h,{children:[(0,x.jsx)(m,{variant:`icon`,children:(0,x.jsx)(c,{})}),(0,x.jsx)(_,{children:`No results found`}),(0,x.jsx)(v,{children:`We couldn't find any branches matching your search. Try a different term or clear the filter.`})]}),(0,x.jsx)(g,{children:(0,x.jsx)(p,{variant:`outline`,onClick:o(),children:`Clear Filter`})})]})}},E={render:C,args:{children:(0,x.jsxs)(h,{children:[(0,x.jsx)(m,{variant:`icon`,children:(0,x.jsx)(d,{})}),(0,x.jsx)(_,{children:`No papers available`}),(0,x.jsx)(v,{children:`There are no question papers uploaded for this subject yet.`})]})}},D={render:C,args:{children:(0,x.jsxs)(h,{children:[(0,x.jsx)(_,{children:`No notifications`}),(0,x.jsx)(v,{children:`You're all caught up!`})]})}},O={render:C,args:{children:(0,x.jsx)(h,{children:(0,x.jsx)(_,{children:`No entries yet`})})}},w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  render: Template,
  args: {
    children: <>
        <EmptyHeader>
