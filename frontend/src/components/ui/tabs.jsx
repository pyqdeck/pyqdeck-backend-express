...
const tabsListVariants = cva(
  'group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col',
  {
    variants: {
      variant: {
        default: 'bg-muted',
        line: 'gap-1 bg-transparent data-[variant=line]:rounded-none',
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'group-data-[variant=pill]/tabs-list:data-active:bg-primary group-data-[variant=pill]/tabs-list:data-active:text-primary-foreground group-data-[variant=pill]/tabs-list:h-8 group-data-[variant=pill]/tabs-list:rounded-full group-data-[variant=pill]/tabs-list:border-2 group-data-[variant=pill]/tabs-list:px-4 group-data-[variant=pill]/tabs-list:text-xs group-data-[variant=pill]/tabs-list:font-bold group-data-[variant=pill]/tabs-list:after:hidden group-data-[variant=pill]/tabs-list:data-active:shadow-none',
